...
public class Datos3 {
	...
	public static Graph<Interseccion, Calle> grafo;
	private static List<Interseccion> vertices;
	public static IntegerVertexGraphView<Interseccion, Calle> g2;
	...
	public static void iniDatos(String file) {
        ...
        g2 = IntegerVertexGraphView.of(grafo);	
        
        System.out.println("1:"+vertices);
        System.out.println("2:"+g2.vertexSet());
        for(Integer k:g2.vertexSet())
            System.out.println("2:"+g2.getVertex(k));
	...
	public static void main(String[] args) throws IOException {
		iniDatos("datos_entrada/ejercicio3/DatosEntrada1.txt");
		iniDatos("datos_entrada/ejercicio3/DatosEntrada2.txt");
		iniDatos("datos_entrada/ejercicio3/DatosEntrada3.txt");
	}
