...
*/
	public static Solucion1 ofEdges(List<Edge1> ls) {
		...
		Solucion1 s = new Solucion1(alternativas); 
		return s;
	}
	
	
	public static Solucion1 of(GraphPath<Vertex1, Edge1> path ) { 
	...
	public Solucion1(List<Integer> ls) { // Lista de acciones/alternativas
		valTotal = gasto = 0.;
	...
	/*public static List<Integer> createBool(List<Boolean> ls) {
